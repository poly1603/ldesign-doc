...
export const routes = [
  {
    path: '/',
    component: () => import('D:/WorkBench/ldesign/libraries/doc/playground/docs/index.md'),
    meta: { 
      title: 'LDoc - 现代化文档系统',
  ...
  {
    path: '/api',
    component: () => import('D:/WorkBench/ldesign/libraries/doc/playground/docs/api/index.md'),
    meta: { 
      title: 'API 参考',
  ...
  {
    path: '/api/client',
    component: () => import('D:/WorkBench/ldesign/libraries/doc/playground/docs/api/client.md'),
    meta: { 
      title: 'client',
      frontmatter: {}
    }
  ...
  {
    path: '/api/theme',
    component: () => import('D:/WorkBench/ldesign/libraries/doc/playground/docs/api/theme.md'),
    meta: { 
      title: 'theme',
      frontmatter: {}
    }
  ...
  {
    path: '/components',
    component: () => import('D:/WorkBench/ldesign/libraries/doc/playground/docs/components/index.md'),
    meta: { 
      title: '',
      frontmatter: {}
    }
  },
  {
    ...
    component: () => import('D:/WorkBench/ldesign/libraries/doc/playground/docs/components/button.md'),
    meta: { 
      title: 'button',
      frontmatter: {}
    }
  ...
  {
    path: '/guide',
    component: () => import('D:/WorkBench/ldesign/libraries/doc/playground/docs/guide/index.md'),
    meta: { 
      title: '',
      frontmatter: {}
    }
  },
  {
    ...
    component: () => import('D:/WorkBench/ldesign/libraries/doc/playground/docs/guide/configuration.md'),
    meta: { 
      title: 'configuration',
      frontmatter: {}
    }
  },
  {
    ...
    component: () => import('D:/WorkBench/ldesign/libraries/doc/playground/docs/guide/getting-started.md'),
    meta: { 
      title: '快速开始',
  ...
  {
    path: '/guide/markdown',
    component: () => import('D:/WorkBench/ldesign/libraries/doc/playground/docs/guide/markdown.md'),
    meta: { 
      title: 'markdown',
      frontmatter: {}
    }
  ...
  {
    path: '/guide/plugin',
    component: () => import('D:/WorkBench/ldesign/libraries/doc/playground/docs/guide/plugin.md'),
    meta: { 
      title: 'plugin',
      frontmatter: {}
    }
  ...
  {
    path: '/guide/theme',
    component: () => import('D:/WorkBench/ldesign/libraries/doc/playground/docs/guide/theme.md'),
    meta: { 
      title: 'theme',
      frontmatter: {}
    }
